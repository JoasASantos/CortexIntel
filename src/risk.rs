...
fn recommend_action(kind: EntityKind, band: RiskBand, domain: Domain) -> String {
    ...
    match (domain, kind) {
        ...
        (Domain::HumanTrafficking, EntityKind::Victim) => "victim_safety_referral".into(),
        (Domain::HumanTrafficking, EntityKind::Suspect | EntityKind::Person) => "identify_controller_and_preserve_evidence".into(),
        (Domain::HumanTrafficking, EntityKind::Url | EntityKind::Selector | EntityKind::Account) => "pivot_ads_and_phones".into(),
        (Domain::HumanTrafficking, EntityKind::Payment | EntityKind::Wallet) => "trace_proceeds".into(),
        (Domain::HumanTrafficking, EntityKind::Facility | EntityKind::Location) => "verify_site_and_movement".into(),
        (Domain::HumanTrafficking, _) => "escalate_to_counter_trafficking".into(),
