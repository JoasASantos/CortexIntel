...
fn lens(d: Domain, lang: &str) -> Lens {
    match lang {
        "pt" => match d {
            ...
            Domain::HumanTrafficking => ls("panorama de tráfico de pessoas", "telefones/contas reutilizados em vários anúncios, hotéis e rotas em comum costumam apontar um mesmo controlador ou rede de exploração", "vítima em risco ou controlador", "acionar a equipe anti-tráfico (Disque 100 / polícia), priorizar a segurança da vítima e preservar as evidências"),
        ...
        "es" => match d {
            ...
            Domain::HumanTrafficking => ls("panorama de trata de personas", "teléfonos/cuentas reutilizados en varios anuncios, hoteles y rutas comunes suelen señalar un mismo controlador o red de explotación", "víctima en riesgo o controlador", "activar al equipo antitrata, priorizar la seguridad de la víctima y preservar la evidencia"),
        ...
        _ => match d {
            ...
            Domain::HumanTrafficking => ls("trafficking picture", "phones/handles reused across ads, shared hotels and common routes usually point to one controller or exploitation network", "at-risk victim or controller", "engage the counter-trafficking unit, prioritise victim safety and preserve evidence"),
